...
{*
				<li aria-haspopup="true" aria-expanded="false">
					<a href="http://omppre.unbosque.edu.co/index.php/GInvFCEAd/management/settings">Translate</a>
					<ul style="">
					...
					{/if}
						...
						{if $displayPageHeaderLogo && is_array($displayPageHeaderLogo)}
							<a href="{$homeUrl}" class="is_img">
								...
								<img src="{$baseUrl}/plugins/themes/default/images/svg/logo_UEB.svg" width="{$displayPageHeaderLogo.width|escape}" height="{$displayPageHeaderLogo.height|escape}" {if $displayPageHeaderLogo.altText != ''}alt="{$displayPageHeaderLogo.altText|escape}"{else}alt="{translate key="common.pageHeaderLogo.altText"}"{/if} />
